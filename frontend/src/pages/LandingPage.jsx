  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
      ...
      {activeView === 'register' && (
        <section style={{ maxWidth: '400px', margin: '60px auto', padding: '0 20px' }}>
          <div className="glass-card" style={{ textAlign: 'center', padding: '36px' }}>
            <div style={{ background: 'rgba(16, 185, 129, 0.08)', width: '60px', height: '60px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px auto', color: 'var(--color-accent-emerald)' }}><UserPlus size={28} /></div>
            ...
            <form onSubmit={handleRegisterSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <button type="submit" className="btn-primary" style={{ justifyContent: 'center', marginTop: '10px', background: 'linear-gradient(135deg, var(--color-accent-emerald) 0%, #059669 100%)', boxShadow: '0 4px 14px rgba(16, 185, 129, 0.2)' }}>패밀리 등록하기 🌰</button>
            </form>
            {authError && <div style={{ marginTop: '16px', color: 'var(--color-accent-orange)', fontSize: '13px' }}>⚠️ {authError}</div>}
      ...
      {activeView === 'subscribe' && (
        <section style={{ textAlign: 'center', maxWidth: '600px', margin: '40px auto 60px auto', position: 'relative' }}>
          ...
          <div className="glass-card no-mobile-padding" style={{ marginTop: '24px', padding: '12px 16px', borderRadius: '20px', background: 'var(--bg-secondary)', border: '1px solid', borderColor: backendWaking ? 'rgba(245, 158, 11, 0.25)' : 'rgba(59, 130, 246, 0.25)', fontSize: '12px', fontWeight: '600', textAlign: 'center', color: backendWaking ? 'var(--color-accent-orange)' : 'var(--color-accent-blue)', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: '8px', width: '100%', boxShadow: backendWaking ? '0 4px 10px rgba(245, 158, 11, 0.05)' : '0 4px 10px rgba(59, 130, 246, 0.05)' }}>
